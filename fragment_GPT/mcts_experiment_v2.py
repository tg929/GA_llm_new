...
import time
from mcts_v2 import MCTSConfig, MolecularProblemState, MCTS, print_best
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file_path', default='./output/cts_5ht1b_v2', help='name of .pt file')
