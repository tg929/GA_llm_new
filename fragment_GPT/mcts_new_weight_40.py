...
class MCTSConfig:
    ...
    search_time = 600    # total search times (equal or larger than than the number of nodes expanded)
    ...
    c_param = 6    # exploration parameter
...
class MCTS:
    ...
    def run_mcts(self):
        ...
        _, smi, = sentence2mol(best_leaf.state.cur_sentence)
