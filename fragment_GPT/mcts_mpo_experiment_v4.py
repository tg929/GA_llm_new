...
import time
from mcts_mpo_v4 import MCTSConfig, MolecularProblemState, MCTS, print_best
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='8', help='device id (i.e. 0 or 0,1 or cpu)')
