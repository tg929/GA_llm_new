...
class MCTSConfig:
    ...
    init_children = 10  # initial number of children to expand at the root node. if -1, use N_TOTAL_CHILDREN. This is a piror knowledge of the problem.
...
class MCTS:
    ...
    def run_mcts(self):
        ...
        self.save_tree('./tree_log/root_v3_seed_1.p')
        # 使用 'w' 模式写入文件，确保指定编码以支持中文
        with open("./tree_log/buffer_v3_seed_1.json", "w", encoding="utf-8") as f:
